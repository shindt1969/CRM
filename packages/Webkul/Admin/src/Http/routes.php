...
Route::prefix("api/" . config('app.admin_path'))->group(function () {
    ...
    Route::group(['middleware' => ['api']], function () {
        ...
        Route::group([
            ...
            Route::get('{page?}', 'NoteController@index')->name('admin.notes.index')->where(['page' => '[0-9]+']);

            Route::post('create', 'NoteController@store')->name('admin.notes.store');

            Route::put('edit/{id}', 'NoteController@update')->name('admin.notes.update');

            Route::delete('{id}', 'NoteController@destroy')->name('admin.notes.delete')->where(['id' => '[0-9]+']);

            Route::put('mass-destroy', 'NoteController@massDestroy')->name('admin.notes.mass_delete');
        });
        ...
        Route::group([
            ...
            Route::get('', 'NoteCategoryController@index')->name('admin.notesCategories.index');

            Route::post('create', 'NoteCategoryController@store')->name('admin.notesCategories.store');

            Route::put('edit/{id}', 'NoteCategoryController@update')->name('admin.notesCategories.update');

            Route::delete('{id}', 'NoteCategoryController@destroy')->name('admin.notesCategories.delete')->where(['id' => '[0-9]+']);

            Route::put('mass-destroy', 'NoteCategoryController@massDestroy')->name('admin.notesCategories.mass_delete');
        });
        ...
        Route::group([
            ...
            // Route::put('edit/{id}', 'NoteController@update');

            // Route::delete('{id}', 'NoteController@destroy')->where(['id' => '[0-9]+']);

            // Route::put('mass-destroy', 'NoteController@massDestroy');
        });
